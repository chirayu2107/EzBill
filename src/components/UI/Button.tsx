...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: "bg-transparent border border-gray-200 dark:border-[#2A2A2E] text-gray-700 dark:text-[#9E9EA7] hover:bg-gray-50 dark:hover:bg-[#27272A] hover:border-gray-300 dark:hover:border-[#3A3A3F] focus:ring-gray-500",
    // Success
