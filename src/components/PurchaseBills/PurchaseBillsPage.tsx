...
const PurchaseBillsPage: React.FC = () => {
  ...
  const stats = [
    { value: "all", label: "All Bills", count: purchaseBills.length, color: "text-gray-900 dark:text-[#F0F0F3]", bg: "bg-gray-50 dark:bg-[#1C1C1F]", activeBg: "bg-gray-100 dark:bg-[#232326]", border: "border-gray-200 dark:border-white/[0.12]" },
