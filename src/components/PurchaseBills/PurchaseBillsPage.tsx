...
const PurchaseBillsPage: React.FC = () => {
  ...
  const stats = [
    { value: "all", label: "All Bills", count: purchaseBills.length, color: "text-gray-900 dark:text-[#ECECEF]", bg: "bg-gray-50 dark:bg-[#1F1F22]", activeBg: "bg-gray-100 dark:bg-[#27272A]", border: "border-gray-200 dark:border-[#3A3A3F]" },
