...
const PurchaseBillsPage: React.FC = () => {
  ...
  const stats = [
    { value: "all", label: "All Bills", count: purchaseBills.length, color: "text-gray-900 dark:text-[#F0F0F3]", bg: "bg-gray-50 dark:bg-[#1A1A1D]", activeBg: "bg-gray-100 dark:bg-[#212124]", border: "border-gray-200 dark:border-white/[0.08]" },
    { value: "paid", label: "Paid", count: purchaseBills.filter(i => i.status === "paid").length, color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-50 dark:bg-emerald-500/8", activeBg: "bg-emerald-100 dark:bg-emerald-500/15", border: "border-emerald-200 dark:border-emerald-500/25" },
    { value: "unpaid", label: "Unpaid", count: purchaseBills.filter(i => i.status === "unpaid").length, color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-50 dark:bg-amber-500/8", activeBg: "bg-amber-100 dark:bg-amber-500/15", border: "border-amber-200 dark:border-amber-500/25" },
    { value: "overdue", label: "Overdue", count: purchaseBills.filter(i => i.status === "overdue").length, color: "text-red-500 dark:text-red-400", bg: "bg-red-50 dark:bg-red-500/8", activeBg: "bg-red-100 dark:bg-red-500/15", border: "border-red-200 dark:border-red-500/25" },
  ]
            ...
            <motion.button
              ...
              className={`relative rounded-2xl border p-4 text-center transition-all duration-200 ${
                isActive
                  ...
                  : `bg-white dark:bg-[#1A1A1D] border-gray-100 dark:border-white/[0.04] hover:border-gray-200 dark:hover:border-white/[0.06]`
              }`}
              whileTap={{ scale: 0.98 }}
            >
