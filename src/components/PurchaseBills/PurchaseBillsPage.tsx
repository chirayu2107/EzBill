...
const PurchaseBillsPage: React.FC = () => {
  ...
  const stats = [
    ...
    { value: "paid", label: "Paid", count: purchaseBills.filter(i => i.status === "paid").length, color: "text-blue-600 dark:text-blue-400", bg: "bg-blue-50 dark:bg-blue-500/8", activeBg: "bg-blue-100 dark:bg-blue-500/15", border: "border-blue-200 dark:border-blue-500/25" },
