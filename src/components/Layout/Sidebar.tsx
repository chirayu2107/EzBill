...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      {/* ═══ MOBILE TOP BAR ═══ */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white dark:bg-[#19191B] border-b border-gray-200 dark:border-[#2A2A2E]">
        <div className="flex items-center justify-between px-4 py-3">
          <button
            onClick={toggleMobileMenu}
            className="p-2 text-gray-500 dark:text-[#9E9EA7] rounded-lg hover:bg-gray-50 dark:hover:bg-[#27272A] transition-colors"
          >
      ...
      <motion.div
        className="hidden lg:flex flex-col shrink-0 overflow-hidden cursor-pointer
                   bg-white dark:bg-[#19191B] border-r border-gray-100 dark:border-[#2A2A2E]"
      ...
      >
        ...
        <div className="flex-1 flex flex-col pt-5 pb-3 overflow-hidden">
          ...
          {/* Divider */}
          <div className={`h-px bg-gray-100 dark:bg-[#2A2A2E] shrink-0 ${isCollapsed ? "mx-3" : "mx-5"} mb-3`} />
                  ...
                  <Link
                    ...
                    className={`group relative flex items-center rounded-xl transition-all duration-200 ${
                      ...
                      isActive
                        ...
                        : "text-gray-600 dark:text-[#9E9EA7] hover:bg-gray-50 dark:hover:bg-[#27272A] hover:text-gray-900 dark:hover:text-[#ECECEF] font-medium"
                    }`}
                  ...
                  >
                    ...
                    <Icon
                      className={`w-[18px] h-[18px] shrink-0 transition-colors ${
                        isActive ? "text-emerald-600 dark:text-emerald-400" : "text-gray-400 dark:text-[#63636E] group-hover:text-gray-600 dark:group-hover:text-[#9E9EA7]"
                      }`}
                    ...
                    {isCollapsed && (
                      <span className="absolute left-full ml-3 px-2.5 py-1.5 rounded-lg bg-gray-900 dark:bg-[#2E2E32] text-white text-[11px] font-medium whitespace-nowrap opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-150 z-50 shadow-xl">
                        {item.label}
                        <span className="absolute right-full top-1/2 -translate-y-1/2 border-4 border-transparent border-r-gray-900 dark:border-r-[#2E2E32]" />
                      </span>
                    )}
                  </Link>
                </motion.div>
        ...
        {/* ── Bottom: User ── */}
        <div className={`shrink-0 border-t border-gray-100 dark:border-[#2A2A2E] ${isCollapsed ? "px-2" : "px-3"} py-3 space-y-2`}>
          ...
          >
            ...
            {!isCollapsed && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] text-gray-400 dark:text-[#63636E] truncate leading-tight">
                  {user?.email}
                </p>
              </div>
            )}
            {!isCollapsed && (
              <button
                ...
                className="p-1.5 text-gray-400 dark:text-[#63636E] hover:text-gray-600 dark:hover:text-[#9E9EA7] hover:bg-gray-100 dark:hover:bg-[#27272A] rounded-lg transition-colors shrink-0"
          ...
          <button
            ...
            className={`group flex items-center rounded-xl h-9 w-full
                       ...
                       text-gray-500 dark:text-[#9E9EA7]
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            className="lg:hidden fixed left-0 top-0 h-full w-72 bg-white dark:bg-[#19191B] border-r border-gray-100 dark:border-[#2A2A2E] flex flex-col z-50"
          ...
          >
                    ...
                    <motion.div key={item.path} variants={menuItemVariants} transition={{ delay: index * 0.05 }}>
                      <Link
                        ...
                        className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors text-sm ${
                          isActive
                            ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 font-semibold"
                            : "text-gray-600 dark:text-[#9E9EA7] hover:bg-gray-50 dark:hover:bg-[#27272A]"
                        }`}
                      >
                        <item.icon
                          className={`w-5 h-5 ${
                            isActive ? "text-emerald-600 dark:text-emerald-400" : "text-gray-400 dark:text-[#63636E]"
                          }`}
            ...
            <motion.div
              className="p-5 border-t border-gray-100 dark:border-[#2A2A2E]"
            ...
            >
              ...
              <button
                onClick={logout}
                className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl border border-gray-200 dark:border-[#2A2A2E] text-gray-600 dark:text-[#9E9EA7] hover:bg-red-50 dark:hover:bg-red-500/8 hover:text-red-600 dark:hover:text-red-400 hover:border-red-200 dark:hover:border-red-500/25 transition-all text-xs font-medium"
              >
