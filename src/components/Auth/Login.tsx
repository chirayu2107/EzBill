...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-surface-light dark:bg-[#0F0F11] text-gray-900 dark:text-white transition-colors duration-300 relative">
      ...
      <div className="hidden md:flex w-full md:w-1/2 items-center justify-end bg-gray-900 dark:bg-[#161618] overflow-hidden px-4 md:px-0 relative">
        ...
        <div className="rounded-2xl border border-gray-700/50 dark:border-white/[0.07] shadow-2xl shadow-black/20 w-full max-w-none scale-[1.10] md:ml-14 overflow-hidden relative z-10">
          <a href="/">
            <img
