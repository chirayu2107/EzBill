  ...
  return (
    <div className="max-w-4xl mx-auto select-none pt-20 lg:pt-0 pb-8">
        ...
        <div className="flex items-center gap-2">
          {!isEditing ? (
            <>
              ...
              {/* Separator */}
              <div className="w-px h-5 bg-gray-200 dark:bg-[#232326] mx-0.5" />
              <button
                type="button"
      ...
      <div className="relative px-2 mb-8">
        <div
          ref={tabsRef}
          className="flex items-center gap-1 border-b border-gray-200 dark:border-white/[0.06]"
        >
          {TABS.map((tab) => {
            const Icon = tab.icon
          ...
          <div className="space-y-6 animate-fade-up">
                ...
                <div>
                  ...
                  <div className="flex gap-2.5">
                    <input
                      ...
                      disabled={!isEditing}
                      className="flex-1 px-3.5 py-2.5 bg-white dark:bg-[#1C1C1F] border border-gray-200 dark:border-white/[0.08] rounded-xl text-[14px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/50 disabled:opacity-60 transition-all shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)]"
            ...
            >
              <div className="p-6">
                ...
                {/* Progress bar */}
                <div className="w-full h-2 bg-gray-100 dark:bg-[#1C1C1F] rounded-full overflow-hidden mb-5">
                  <div
