      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <Card className="text-center py-12 md:py-16">
          <motion.div
            ...
            className="mb-4"
          >
            <div className="w-14 h-14 bg-gray-100 dark:bg-[#1F1F22] rounded-2xl flex items-center justify-center mx-auto">
              <FileX className="w-7 h-7 text-gray-400 dark:text-[#63636E]" />
            </div>
          </motion.div>
            ...
            <AnimatePresence>
              {invoices.map((invoice, index) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-[#ECECEF] rounded-md hover:bg-gray-100 dark:hover:bg-[#27272A] transition-colors"
                        >
                        ...
                        <AnimatePresence>
                          {activeDropdown === invoice.id && (
                            ...
                            >
                              ...
                              <div className="border-t border-gray-100 dark:border-[#2A2A2E] my-1" />
                              <button
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs bg-gray-50/50 dark:bg-[#1A1A1E]/50 p-2.5 rounded-lg">
                    <div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 dark:border-[#2A2A2E]">
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Invoice #</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Customer</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Date</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Amount</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">GST</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Total</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Status</th>
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-[#63636E] uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody>
                <AnimatePresence>
                  {invoices.map((invoice, index) => (
                    <motion.tr
                      ...
                      exit={{ opacity: 0, y: -4 }}
                      transition={{ delay: index * 0.04 }}
                      className="border-b border-gray-50 dark:border-[#2A2A2E]/50 hover:bg-gray-50/80 dark:hover:bg-[#27272A]/50 transition-colors duration-150 group"
                    >
        ...
        {deleteConfirm && (
          ...
          >
            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-[#1F1F22] rounded-lg p-3 mb-5 border border-gray-100 dark:border-[#2A2A2E]">
