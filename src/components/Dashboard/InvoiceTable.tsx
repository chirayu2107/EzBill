            ...
            <AnimatePresence>
              {invoices.map((invoice, index) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-white rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                        >
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs bg-gray-50/50 dark:bg-gray-800/30 p-2.5 rounded-lg">
                    <div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  <th className="text-left py-3 px-4 text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Invoice #</th>
                ...
                <AnimatePresence>
                  {invoices.map((invoice, index) => (
                    <motion.tr
                      ...
                      exit={{ opacity: 0, y: -4 }}
                      transition={{ delay: index * 0.04 }}
                      className="border-b border-gray-50 dark:border-gray-800/30 hover:bg-gray-50/80 dark:hover:bg-white/[0.02] transition-colors duration-150 group"
                    >
        ...
        {deleteConfirm && (
          ...
          >
            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3 mb-5 border border-gray-100 dark:border-gray-700/50">
