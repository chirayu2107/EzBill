...
import { Eye, CheckCircle, XCircle, Download, Edit, Trash2, AlertTriangle } from 'lucide-react';
...
const InvoiceTable: React.FC<InvoiceTableProps> = ({ invoices, onViewInvoice, onEditInvoice }) => {
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-gray-300">
                        {invoice.gstBreakdown.isInterState ? (
                          ...
                          <span>
                            {formatCurrency(invoice.gstBreakdown.cgst + invoice.gstBreakdown.sgst)}
                          </span>
                        )}
                      </td>
            ...
            >
              ...
              <div className="bg-gray-700 rounded-lg p-3 mb-6">
                <p className="text-sm text-gray-300">
                  Invoice: <span className="text-white font-medium">
